...
-- Copiando dados para a tabela aidiomas_db.admin: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `admin` DISABLE KEYS */;
REPLACE INTO `admin` (`usuario`, `senha`, `nivel`) VALUES
	('Marcelo', '123', 1);
...
REPLACE INTO `mural` (`id`, `title`, `summary`, `content`, `date`) VALUES
	...
	(6, 'marcelo', 'abstract to test', 'full content abstract to test... It works perfectly', '2016-01-21');
...
REPLACE INTO `professor` (`nome`, `sobrenome`, `telefone`, `email`, `idioma`, `usuario`, `senha`, `nivel`, `id`) VALUES
