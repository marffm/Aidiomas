                            ...
                            <div class="panel panel-default">
                                ...
                                <form action="cadastroGrupo/validateGrupo" method="POST" class="panel-body">
                                    ...
                                    <select name="codigo_aluno" id="codigo_aluno" class="form-control" required>
                                        ...
                                        <option value="<?php echo $alunos['codigo'] ?>"><?php echo $alunos['codigo'] ?></option>
                                        <?php } ?>
                                    </select>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <span>Idioma: <strong><?php echo $grupos['idioma'] ?></strong>  |  Level: <strong><?php echo $grupos['level_grupo'] ?></strong>  |  Semestre: <strong><?php echo $grupos['semestre'] ?></strong>  |  Professor: <strong><?php echo $grupos['nome_prof'] ?></strong></span>
                                    <table class="table table-hover table-bordered tabelaGrupo">                                        
                                        ...
                                        <tr>
                                            ...
                                            <td class="inserir">Já Inserido</td>
                                            <td class="deletar"><a href="#">Delete Icon</a></td>                                            
                                        </tr>
                                        <?php } ?>
                                        <?php } ?>
                                        <tr>
                                        <form action="cadastroGrupo/updateGrupo" method="POST">
                                            <td class="codigoaluno">                                                
                                                <select name="codigo_aluno" id="codigo_aluno" class="form-control">
                                                    <?php foreach ($data['alunolist'] as $alunos) { ?>
                                                    <option value="<?php echo $alunos['codigo'] ?>"><?php echo $alunos['codigo'] ?></option>
                                                    <?php } ?>
                                                </select>                                                
                                            ...
                                            <td class="sobrenome">teste</td>
                                            
                                        </form>

                                        
                                        <td class="inserir"><a href="#">Insert Icon</a></td>
                                        <td class="deletar"><a href="#">Delete Icon</a></td>
                                        </tr>
                                    </table> 
                                </div>
